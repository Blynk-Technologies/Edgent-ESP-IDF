...
#define BLYNK_STR_HELPER(x) #x
#define BLYNK_STR(x) BLYNK_STR_HELPER(x)
...
#error "ESP_SYSTEM_EVENT_TASK_STACK_SIZE should be >= 2560 (current: " BLYNK_STR(CONFIG_ESP_SYSTEM_EVENT_TASK_STACK_SIZE) ")"
#endif
